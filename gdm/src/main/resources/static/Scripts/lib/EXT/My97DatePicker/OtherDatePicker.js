...
var tiannetSecond = tiannetDateNow.getSeconds();
...
var m_bolShowSecond = false;//是否显示秒钟
...
tiannetSecond = strTime.substring(5,7);
}
// ---------------------- end 用户可调用的函数 -----------------------------//
//------------------ begin 页面显示部分 ---------------------------//
...
if(m_bolShowSecond) hideElementsById(new Array("tiannetSecondHead"),false);
hideElementsById(new Array("tiannetYearHead","selTianMonth","selTianHour","selTianMinute","selTianSecond"),true);
}
//单击月份span标签响应
...
if(m_bolShowMinute) hideElementsById(new Array("tiannetMinuteHead"),false);
if(m_bolShowSecond) hideElementsById(new Array("tiannetSecondHead"),false);
hideElementsById(new Array("tiannetMonthHead","selTianYear","selTianHour","selTianMinute","selTianSecond"),true);
}
//单击小时span标签响应
...
if(m_bolShowMinute) hideElementsById(new Array("tiannetMinuteHead"),false);
if(m_bolShowSecond) hideElementsById(new Array("tiannetSecondHead"),false);
hideElementsById(new Array("tiannetHourHead","selTianYear","selTianMonth","selTianMinute","selTianSecond"),true);
}
//单击分钟span标签响应
...
if(m_bolShowSecond) hideElementsById(new Array("tiannetSecondHead"),false);
hideElementsById(new Array("tiannetMinuteHead","selTianYear","selTianMonth","selTianHour","selTianSecond"),true);
}
//单击秒钟span标签响应
...
if( m_bolShowSecond ) document.all.tiannetSecondHead.innerText = tiannetSecond + "秒";
...
hideElementsById(new Array("selTianYear","selTianMonth","selTianHour","selTianMinute","selTianSecond"),true);
hideElementsById(new Array("tiannetYearHead","tiannetMonthHead","tiannetHourHead","tiannetMinuteHead","tiannetSecondHead"),false);
