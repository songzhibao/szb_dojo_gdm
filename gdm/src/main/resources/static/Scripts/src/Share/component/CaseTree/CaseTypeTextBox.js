define([
    ...
    'dojo/json',
    "egis/cache"
], function (date, locale, stamp, declare, lang,Evented, TextBox, _HasDropDown, CaseTypePicker, JSON, cache) {

    return declare('egis/Share/component/CaseTree/CaseTypeTextBox', [TextBox, _HasDropDown, Evented], {
        ...
        popupClass: CaseTypePicker, // default is no popup = text only
        ...
        postCreate: function () {
            ...
            this.dropDown = new PopupProto({
                ...
                onChange: lang.hitch(this, function (value) {
                    ...
                    me.setValue(me.formatShowText(value));
