...
define([
    ...
    "egis/Modules/Deduce/DeduceModule",
...
], function (declare, AppLoader, MapModule, DeduceModule, EditMapModule, GeoMapModule, ResourceMapModule, MapBuilder, mapConfig, appConfig) {
