...
define([
...
], function (declare, baseFx, lang,array, domClass, domGeom,Evented, on, topic, TemplatedMixin, _WidgetsInTemplateMixin, ContentPane, Standby, TextBox,_WidgetBase, Button, TooltipDialog, DropDownButton, template, 
    ...
    var FixedPane = declare([_WidgetBase, TemplatedMixin, _WidgetsInTemplateMixin, Evented], {
        ...
        startup: function () {
            ...
            this.connect(this.CK_CASE_SD, "change", lang.hitch(this, this._check_Change));
            this.connect(this.CK_CASE_RD, "change", lang.hitch(this, this._check_Change));
            //this.connect(this.CK_CASE_HBSSYJ, "change", lang.hitch(this, this._check_Change));
        ...
        _check_Change : function()
        {
            ...
            //获取周边警力资源
            var paramObj = {
                actionType: "/Case/GetCases",
                actionExplain: "获取警情资源",
                startTime: start,
                endTime: end,
            ...
            // this.CK_CASE_HBSSYJ.checked
            this.currentRequest = { getDataUrl: "/caseinfo/getCaseInfoList", IsPostJson: true, LayerGroup: "警情上图", LayerId: "上图警情", actionExplain: paramObj.actionExplain, actionType: paramObj.actionType, paramObject: paramObj, checkSD: this.CK_CASE_SD.checked, checkRD: this.CK_CASE_RD.checked, checkSSYJ: false };
        ...
        getCurrentRequest : function()
        {
            ...
            if (dateTimeInfo)
            {
                this.currentRequest.startTime = dateTimeInfo.timeSpan[0].toJSON();
                this.currentRequest.endTime = dateTimeInfo.timeSpan[1].toJSON();
            }
