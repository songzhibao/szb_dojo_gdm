...
'egis/appEnv'
    ...
    return declare([_Module], {
        ...
        startup: function () {
            ...
            if (appEnv.appConfig.GpsOtherConnectString == "")
            {
                return;
            }
            window.gpsListen = new wsImpl(appEnv.appConfig.GpsOtherConnectString);
        ...
        ParseMessage : function (msgString) {
            ...
            if (array.length == 8) {
                if (array[0] == "GPS") {
                    ...
                    appEnv.publishMainPane("egis/other/updategps", { GPSId: array[1], Lon: array[2], Lat: array[3], Speed: array[4], Angle: array[5], GpsTime: array[6], Status: array[7] }, "GPS");
                }
            }
        }
