...
define([
    ...
    'egis/appEnv',
    "dojo/text!./PolygonSettingWidget.html"
    ...
    return declare([_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin], {
        ...
        startup: function () {
            ...
            this.regionFillColorPicker.on("change", lang.hitch(this, this.colorFillPickerOnChange));
            this.regionLineColorPicker.on("change", lang.hitch(this, this.colorLinePickerOnChange));

            if (this.data != null) {
                this.ItemName.setValue(this.data.MC);
                this.ItemStage.setValue(this.data.Stage);
                this.ItemSpinner.setValue(this.data.LineWidth);
                this.ItemOpacite.setValue(this.data.Opacite);
                this.colorLinePickerOnChange(this.data.LineColor);
                this.colorFillPickerOnChange(this.data.FillColor);
            }
        },

        colorFillPickerOnChange: function (color) {
            this.ItemFillColor.domNode.style.backgroundColor = color;
            this.ItemFillColor.setValue(color);
        },

        colorLinePickerOnChange: function (color) {
            this.ItemLineColor.domNode.style.backgroundColor = color;
            this.ItemLineColor.setValue(color);
        },
        ...
        Save_Click: function () {
            request.post("/deduce/saveRegionInfo", {
                data: {
                    ...
                    LineColor: this.ItemLineColor.getValue(),
                    FillColor: this.ItemFillColor.getValue(),
                    Opacite: this.ItemOpacite.getValue()
                },
                handleAs: "json"
