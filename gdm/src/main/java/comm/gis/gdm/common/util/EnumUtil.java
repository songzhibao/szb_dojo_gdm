package comm.gis.gdm.common.util;

import org.apache.commons.collections4.CollectionUtils;
import org.apache.commons.lang3.StringUtils;

import comm.gis.gdm.common.enumeration.BaseEnum;
...
public class EnumUtil {
     ...
     * @return
     */
    // public static <T extends BaseEnum> List<Object> differenceValueList(Class<?
    // extends BaseEnum> enumClass,
    // T... exclude) {
    ...
    public static <T> String getEnumDescByValueList(Collection<T> values, Class<? extends BaseEnum> enumClass) {
        ...
        return Stream.of(enumClass.getEnumConstants()).filter(e -> values.contains(e.getValue())).map(BaseEnum::getDesc)
     ...
     * @param <T>
     */
    public static <T> void inject(List<T> list, Function<T, Integer> getter, BiConsumer<T, String> setter,
